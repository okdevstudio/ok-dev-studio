...
function FlappyBirdPolicy() {
  return (
    <main style={{ margin: "8px" }}>
      ...
      <p>
        Ok Dev built the Flappy Bird app as an Ad Supported app. This SERVICE is
        provided by Ok Dev at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        but not limited to User Analytics Data . The information that I request
      ...
      <p>
        ...
        hesitate to contact me at okdevstudio@gmail.com.
      </p>
      <p>
