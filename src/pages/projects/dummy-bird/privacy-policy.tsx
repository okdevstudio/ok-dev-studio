    ...
    <React.Fragment>
      ...
      <main style={{ margin: "8px" }}>
        ...
        <p>
          ...
          but not limited to User Analytics Data . The information that I
        ...
        <div>
          <p>
            ...
            children under 13 years of age. In the case I discover that a child
            ...
            information, please contact me so that I will be able to do the
            necessary actions.
          </p>
        </div>
        {/* <!----> */}
        ...
        <p>This policy is effective as of 2022-05-31</p>
        <p>
          <strong>Contact Us</strong>
        </p>
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at okdevstudio@gmail.com.
        </p>
      </main>
    </React.Fragment>
  );
